...
public class IdleState : IState
{
    ...
    public IdleState(bool _isAvailable, EnemyAI SM, Material enemyMaterial, Transform myTransform, GameObject player, float yellowZoneRadius, Vector3 startPoint, Vector3 endPoint, float speed, NavMeshAgent agent) {
        //Needs
